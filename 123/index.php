...
<body>
    ...
    <nav>
        ...
        <div class="name">
            ...
            <span class="userShowName"><a href="member.php"><?echo $row[1]; ?></a></span>
        </div>
    </nav>
    <header>
        <div class="banner">
    ...
    ?>
        <nav>
            ...
            <div class="name">
                <a href="login.php" class="disappear">
        ...
        <div class="menu">
            ...
            <div class="drink">
                ...
                <div class="drinkIntro">
                    ...
                    <div class="addToCart">
                        <a href="addToCart.php?drink_id=<?echo $row[0]; ?>"><i class="fas fa-plus-circle"></i></a>
                    </div>
                    <!--addToCartEnd-->
