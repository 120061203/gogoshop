...
<body>
    ...
    <div class="container">
        <div class="addToCartArea">
            ...
            <div class="menu">
                <div class="drink">
                    <img src=imgs/<?echo $row[0]; ?>.png alt="">
                ...
                <form action="cart.php" method="get">
                    <table>
                        <tbody>
                            ...
                            <tr>
                                <td>甜度</td>
                                <td><label>全糖<input type="radio" value="10" name="sweet" checked></label></td>
                                <td><label>少糖<input type="radio" value="7"  name="sweet"></label></td>
                                <td><label>半糖<input type="radio" value="5"  name="sweet"></label></td>
                                <td><label>微糖<input type="radio" value="3"  name="sweet"></label></td>
                                <td><label>無糖<input type="radio" value="0"  name="sweet"></label></td>
                            </tr>
                            <tr>
                                <td>冰熱</td>
                                <td><label>正常<input type="radio" value="10" name="ice" checked></label></td>
                                <td><label>少冰<input type="radio" value="7"  name="ice"></label></td>
                                <td><label>微冰<input type="radio" value="5"  name="ice"></label></td>
